...
/**
 * Centralized constants and utility methods for the OpenDST Maven Plugin.
 */
final class Commons {
    private Commons() {}
    ...
    static final String JAVA_DEBUG_OPTS =
            "-agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=localhost:5005";

    static final String RUNS_BASE_DIR = "runs";
    static final String INSTRUMENTED_WARS_DIR = "instrumented-wars";
    static final String WARS_DIR = "target/wars";
    static final String FAILURE_BASE_DIR = "failures";
    static final String RUN_DIR_FORMAT = "run-%d";
    static final String LOG_SOURCE_SIMULATOR = "simulator";

    record SignalEvent(long iteration, Signal signal) {}

    static void deleteRecursively(Path basePath, Path directoryToDelete) throws IOException {

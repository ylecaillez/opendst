...
/**
 * Tests a liveness violation: the {@code sometimes} assertion is never true,
 * so the simulation session should fail at runtime.
 */
public final class LivenessViolationApp {

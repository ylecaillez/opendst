...
import com.pingidentity.opendst.api.LogMonitor.Log;
...
final class ConsoleCapture {
    ...
    ConsoleCapture(Simulator simulator, LogMonitor logMonitor, PrintStream out) {
    ...
    void processLogs() throws Throwable {
        for (var unprocessedLog : unprocessedLogs) {
            logMonitor.process(unprocessedLog);
        }
